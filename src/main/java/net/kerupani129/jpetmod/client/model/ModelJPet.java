...
public abstract class ModelJPet extends ModelBase {
	...
	public ModelJPet() {
		...
		jpetRightCheek.setTextureSize(64, 32);
		...
		jpetLeftCheek.setTextureSize(64, 32);
		...
		jpetRightArm.setTextureSize(64, 32);
		...
		jpetLeftArm.setTextureSize(64, 32);
		...
		jpetTailRoot.setTextureSize(64, 32);
		...
		jpetRightThigh.setTextureSize(64, 32);
		...
		jpetRightFoot.setTextureSize(64, 32);
		...
		jpetLeftThigh.setTextureSize(64, 32);
		...
		jpetLeftFoot.setTextureSize(64, 32);
